...
import com.next.chat.common.api.response.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleDatabaseException(DataAccessException ex) {
        ...
        return new ResponseEntity<>(ApiResponse.fail(ResponseCode.DATABASE_ERROR), ResponseCode.DATABASE_ERROR.getStatus());
    }
